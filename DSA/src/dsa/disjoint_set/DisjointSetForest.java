 ...
 * @author Dr. King
 * @param <E>
 *            the type of elements stored in the disjoint set
 */
public interface DisjointSetForest <E> {
     ...
     *
     * @param element
     *            the element that will be contained in the new disjoint set
     ...
     *
     * @param element
     *            the element for which to locate
     * @return the position that identifies the disjoint set that contains the
     *         given element
     */
     ...
     *
     * @param s
     *            the position that identifies the first disjoint set for the
     *            union
     * @param t
     *            the position that identifies the second disjoint set for the
     *            union
     */
