...
public class SeparateChainingHashMap<K extends Comparable<K>, V> extends AbstractHashMap<K, V> {
    ...
    /**
     * Put method for Hash, similar semantics to Public Put method
     * but for a key k that is known to hash to bucket h
     * - Textbook
    ...
    /**
     * Mimic the semantics of the public remove method
     * but for key k that is known to hash to bucket h
     * - Textbook
