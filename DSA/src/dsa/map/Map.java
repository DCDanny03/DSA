 ...
 * @param <V>
 *            the type of values that are associated with keys in the map
 */
public interface Map <K, V> extends Iterable<K> {

    /**
     * Returns an Iterable collection of all of the entries stored within the
     * map
     * 
     * @return an Iterable collection of all of the entries stored within the
     *         map
     */
     ...
     * 
     * @param key
     *            the key of the entry for which to locate the associated value
     ...
     * provided value. If an entry with the provided key already exists within
     * the Map, the value associated with the existing key is replaced with the
     ...
     *         otherwise, return the original value that was replaced with the
     *         newly provided value
     */
    V put ( K key, V value );

    /**
     * Removes the entry with the provided key from the map and returns the
     * value of that entry
     * 
     * @param key
     *            the key of the entry to remove from the map
     * @return the value of the entry that was removed from the map, or null if
     *         an entry with the provided key did not exist within the map
     */
    V remove ( K key );
    ...
    /**
     * The Entry abstract data type defines behaviors for retrieving key and
     * value data that are stored within the entry
     * 
     * @author Dr. King
     *
     * @param <K>
     *            the type of key stored in the entry
     * @param <V>
     *            the type of value stored in the entry
     */
